...
\input{outputs/summary_stats/var_table_1}
...
\begin{table}[h] %maybe put on top
    \centering
    \input{outputs/regressions/tfed_exante_model}
    \caption{}
    \label{tab: tfed_exante_model}
\end{table}
\begin{table}[h]
    \centering
    \input{outputs/regressions/tlocal_exante_model}
    \caption{}
...
Tables \ref{tab: male_expost_model} and \ref{tab: female_expost_model} present regression results from “pull factor” models split by gender. Table \ref{tab: sex_exante_model} and \ref{tab: female_expost_model} present regression results from “push factor” models split by gender. Model 1, Model 2, and Model 3 refer to the varying levels of controls that differentiated columns 1, 2, and 3 in the main model regressions.  Figure \ref{fig: sex_post_diffs} illustrates the underlying trends of the “pull factor” model while figure \ref{fig: sex_ante_diffs} illustrates the underlying trends of the “push factor” model by region.
...
\begin{table}[h] %maybe put on top
    \centering
    \input{outputs/regressions/male_expost_model}
    \caption{}
    \label{tab: male_expost_model}
\end{table}
\begin{table}[h]
    \centering
    \input{outputs/regressions/female_expost_model}
    \caption{}
    \label{tab: female_exante_model}
\end{table}
\begin{table}[h] %maybe put on top
    \centering
    \input{outputs/regressions/male_exante_model}
    \caption{}
    \label{tab: male_exante_model}
\end{table}
\begin{table}[h]
    \centering
    \input{outputs/regressions/female_exante_model}
    \caption{}
    \label{tab: female_exante_model}
\end{table}
...
\begin{table}[h] %maybe put on top
    \centering
    \input{outputs/regressions/midwest_exante_model}
    \caption{}
    \label{tab: midwest_exante_model}
\end{table}
\begin{table}[h]
    \centering
    \input{outputs/regressions/south_exante_model}
    \caption{}
...
\input{outputs/summary_stats/pop_support}
...
\begin{landscape}
\input{outputs/summary_stats/var_table_2}
\end{landscape}

\input{outputs/summary_stats/regions_2}
...
\begin{table}[h] %maybe put on top
    \centering
    \input{outputs/regressions/flocal_expost_model}
    \caption{}
    \label{tab: flocal_expost_model}
\end{table}
\begin{table}[h]
    \centering
    \input{outputs/regressions/fstay_expost_model}
    \caption{}
...
\begin{table}[h] %maybe put on top
    \centering
    \input{outputs/regressions/midwest_expost_model}
    \caption{}
    \label{tab: midwest_expost_model}
\end{table}
\begin{table}[h]
    \centering
    \input{outputs/regressions/south_expost_model}
    \caption{}
    \label{tab: south_expost_model}
\end{table}
\begin{table}[h] %maybe put on top
    \centering
    \input{outputs/regressions/west_expost_model}
    \caption{}
    \label{tab: west_expost_model}
\end{table}
\begin{table}[h]
    \centering
    \input{outputs/regressions/northeast_expost_model}
    \caption{}
    \label{tab: northeast_expost_model}
\end{table}
\begin{table}[h] %maybe put on top
    \centering
    \input{outputs/regressions/west_exante_model}
    \caption{}
    \label{tab: west_exante_model}
\end{table}
\begin{table}[h]
    \centering
    \input{outputs/regressions/northeast_exante_model}
    \caption{}
