...
*normalize + take opposite of pop. support (anti support) for effects to line up to aggravate expected results (be careful naming conventions)
///Models 1 and 2 inputs
clear
use "C:\Users\njrich\Downloads\clean_dataframe.dta" 
gen post_treatment = (1-.01*expost_support)*in_samesex*expost_old_legal*post_2015 
gen ante_treatment = (1-.01*exante_support)*in_samesex*exante_old_legal*post_2015
