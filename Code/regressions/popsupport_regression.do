...
*take inverse of pop. support for effects to line up to aggravate expected results
///Models 1 and 2 inputs
clear
use "C:\Users\njrich\Downloads\clean_dataframe.dta" 
gen post_treatment = (100-post_support)*in_samesex*expost_old_legal*post_2015 
gen ante_treatment = (100-post_support)*in_samesex*exante_old_legal*post_2015
...
outreg2 using "C:\Users\njrich\Desktop\same-sex-migration\outputs\regressions\popsupport_expost_model.tex", ///
	replace ///
	tex(fragment) ///
	title(Ex-Post Model - Inverse Popular Support) ///
	ctitle(Model 1) ///
	label ///
	dec(3) ///
	se ///
...
outreg2 using "C:\Users\njrich\Desktop\same-sex-migration\outputs\regressions\popsupport_exante_model.tex", ///
	replace ///
	tex(fragment) ///
	title(Ex-Ante Model - Inverse Popular Support) ///
	ctitle(Model 1) ///
	label ///
	dec(3) ///
	se ///
