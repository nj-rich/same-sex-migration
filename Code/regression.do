...
*label variable in_samesex#expost_old_legal#post_20151 1 1  "Interaction"
*need more later

*base regressions
* ex post regression
reghdfe migrant in_samesex##expost_old_legal##post_2015 [w=perwt], absorb(expost_state year) vce(cluster expost_state year)
outreg2 using "C:\Users\njrich\Desktop\same-sex-migration\outputs\expost_base_model.tex", replace tex title(Ex-Post Model) label dec(3) se pval addstat(N, e(N))
