...
WHAT FOLLOWS IS PRELIMINARY ANALYSIS; SUPERFICIAL CLEANING STILL NEEDED SO ANALYSIS SHOULD NOT BE TAKEN SERIOUSLY
...
extra_variables <- df_samesex %>% #question: 
...
samesex_staterate_cleanish <- samesex_staterate %>%
...
#current plan of attack: use STATA/Wolfers code
