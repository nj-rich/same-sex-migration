...
Make pct same-sex by state and year var (see weighting/exclusions) - WATCH STILL NEED SEPARATE BY GENDER (MOVED INTERSTATE MIGRANTS FILTER TO MARCEN/MORALES)
```{r, include = F}
gc()
