...
#THIS LEAVES AN ODD AMOUNT OF OBSERVATIONS
...
Make pct same-sex by state and year var (see weighting/exclusions) - UPDATED - still getting opposite results; make sure population definition makes sense(see MM page 5 under the equation)
```{r, include = F}
gc() 
df <- df_samesex_mm
