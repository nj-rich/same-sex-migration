...
if(label == "expost") {
  df <- df %>%
    rename(state = "expost_state", date_legalization = "expost_date_legalization", legal_state = "expost_legal_state", old_legal = "expost_old_legal")
}  
else if(label == "exante") {
  df <- df %>%
    rename(state = "exante_state", date_legalization = "exante_date_legalization", legal_state = "exante_legal_state", old_legal = "exante_old_legal")
}
...
selected_data <- stata_analysis %>%
  select(migrant, in_samesex, expost_old_legal, post_2015, sex, age, race, educ, occ, ind, bpl, inctot, perwt, year, expost_state)
