...
Make file smaller for more efficient running, export to STATA
```{r, include = F}
gc()
...
#mac test
model <- feols(migrant ~ in_samesex * old_legal * post_2015 + i(sex), weights = ~perwt, data = cleanish) #stil need to cluster
