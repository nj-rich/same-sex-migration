...
#check ex-post ex-ante labeling- test by unique-ing
```
...
selected_data <- working_df %>%
  select(migrant, localtolocal_migrant, localtofed_migrant, fedtofed_migrant, fedtolocal_migrant, in_samesex, expost_old_legal, exante_old_legal, post_2015, sex, age, race, educ, occ, ind, bpl, has_child, inctot, perwt, year, expost_state, exante_state)
rm(W25_pull1, summary_stats, add_context, technical_cleaning)
