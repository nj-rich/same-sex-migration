...
joint_control_table <- prop_fem_samesex %>%
  ...
  #colnames(Year, Same-Sex, Opposite-Sex, Same-Sex, Opposite-Sex, Same-Sex, Opposite-Sex, Same-Sex, Opposite-Sex, Same-Sex, Opposite-Sex) %>% #needs work
